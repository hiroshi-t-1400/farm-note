...
class UserChangeApplicationRejected extends Notification
{
    use Queueable;
    ...
    /**
     * 申請種別、申請の状態、再申請の親申請id、申請日、却下実行日（更新日）、申請内容確認画面へのリンクを格納
     *
    ...
    public function toArray(object $notifiable): array
    {
        return [
            ...
            'url' => route('admin.applications.users.edit', ['changeApplication' => $this->change_application]),
        ];
    }
}
