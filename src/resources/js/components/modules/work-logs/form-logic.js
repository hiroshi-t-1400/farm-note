export function storeFormLogic (initialData) {
    ...
    return {
        ...
        init() {
            // this.formData.work_date = this.getToday; only create
            this.resetFormData();
            //debug
        ...
        changeCropSeasons() {
            ...
            this.formData.cropName = newCropSeason.crop_name;
            this.formData.cropSeasonNameYear = newCropSeason.crop_season_nameYear;
        },
