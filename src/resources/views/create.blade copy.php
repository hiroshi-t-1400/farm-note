            ...
            <form action="" method="post">
                ...
                <div class="input-form-inner ">
                    ...
                    <div class="grid grid-cols-1 bg-white mb-1 px-1 py-2">
                        ...
                        <div x-data="{
                            ingredients: [{ name: '', amount: '', material: '' }]
                        }">
                            ...
                            <template x-for="(ingredient, index) in ingredients" :key="index">
                                <div class="grid grid-cols-2 rounded-md border border-gray-200 text-sm">
                                    <h4 class="">資材１</h4>
                                    <div class="">
                                        <div class="text-xs text-gray-400">種別：</div>
                                        <div class="font-medium text-gray-900" x-text="material?.type || '未登録'"></div>
                                        <button
                                            type="button"
                                            @click="ingredients.splice(inde, 1)"
                                    ...
                                    <div>
                                        ...
                                        <div class="font-medium text-gray-900" x-text="material?.name || '未登録'"></div>
                                    </div>

                                    <div>
                                        <div class="text-xs text-gray-400">メーカー名：</div>
                                        <div class="font-medium text-gray-900" x-text="material?.manufacturer || '未登録'"></div>
                                    </div>
                        ...
                        <button
                            type="button"
                            @click="ingredients.push({ name: '', amount '', material: ''})"
